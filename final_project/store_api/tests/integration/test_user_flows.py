...
@patch("order.views.reserve_stock")
@patch("order.views.send_order_confirmation_email")
def test_create_order(
    mock_send_order_confirmation_email,
    mock_reserve_stock,
    mock_confirm_reservation,
    client,
):
    mock_reserve_stock.return_value = "11111111-1111-1111-1111-111111111111"
    ...
    assert order.reservation_id == "11111111-1111-1111-1111-111111111111"
    mock_confirm_reservation.assert_called_once_with(order.reservation_id)
...
@pytest.mark.django_db
@patch("order.views.reserve_stock")
def test_create_order_rejected_by_stock_service(mock_reserve_stock, client):
    mock_reserve_stock.side_effect = StockServiceError(
