...
# stock_api - the warehouse service this project reserves/confirms/cancels
# stock with at checkout. See order/stock_client.py.
STOCK_API_URL = os.environ.get("STOCK_API_URL", "http://localhost:8001")
STOCK_API_TOKEN = os.environ.get("STOCK_API_TOKEN")

# How long a CARD order is allowed to sit unpaid before
# order.tasks.cancel_stale_orders cancels it and releases its reservation.
...
CELERY_BEAT_SCHEDULE = {
    ...
    "cancel-stale-orders": {
        "task": "order.tasks.cancel_stale_orders",
        "schedule": 60 * 15,
    },
}
